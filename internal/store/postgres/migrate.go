...
//go:embed migrations/041_user_role_parent_models.up.sql
var migration041Up string
...
//go:embed migrations/044_security_collaboration.up.sql
var migration044Up string

//go:embed migrations/045_security_notifications.up.sql
var migration045Up string

//go:embed migrations/046_security_suppressions.up.sql
var migration046Up string

//go:embed migrations/047_security_retention.up.sql
var migration047Up string
...
//go:embed migrations/053_agent_bug_report_fix.up.sql
var migration053Up string

//go:embed migrations/054_user_model_defaults_auth_mode.up.sql
var migration054Up string

//go:embed migrations/055_security_research.up.sql
var migration055Up string
...
//go:embed migrations/061_security_research_actor_indexes.up.sql
var migration061Up string

//go:embed migrations/062_security_submission_lifecycle.up.sql
var migration062Up string
...
var noTxMigrations = map[int]bool{40: true, 49: true, 60: true, 61: true}
...
func orderedMigrations() []schemaMigration {
	return []schemaMigration{
		...
		{44, migration044Up, false},
		{45, migration045Up, false},
