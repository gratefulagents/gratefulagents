...
type SecurityScanSpec struct {
	...
	// empty, the controller resolves the default-deep-scan SecurityWorkflow in
	// this scan's namespace. Mutually exclusive with workflowRef: setting both
	// makes the controller report Ready=False with reason InvalidSpec.
