...
func DefaultSecurityWorkflow() []SecurityScanTask {
	...
	tasks = append(tasks,
		SecurityScanTask{Name: "attack-surface-mapping", Role: "threat-modeler", Category: "recon", Objective: "Map the application's attack surface: entry points, exposed endpoints, trust boundaries, privileged operations, and data flows from untrusted input to sensitive sinks.", Tools: &SecurityScanTaskTools{Denied: []string{"bash"}}, SkillRefs: []platformv1alpha1.NamedRef{{Name: "trail-of-bits-audit-context-building"}}},
		SecurityScanTask{Name: "authn-authz", Role: "vulnerability-hunter", Category: "authn", Objective: "Hunt for authentication and authorization flaws: missing or bypassable auth checks, broken session handling, privilege escalation paths, and insecure token validation.", Tools: &SecurityScanTaskTools{Denied: []string{"bash"}}, SkillRefs: []platformv1alpha1.NamedRef{{Name: "api-authz-hunting"}, {Name: "web-app-hunting"}}},
		SecurityScanTask{Name: "injection-and-input-handling", Role: "vulnerability-hunter", Category: "injection", Objective: "Hunt for injection and unsafe input handling: SQL/NoSQL/command/template injection, XSS, path traversal, and unsanitized data reaching interpreters or shells.", Tools: &SecurityScanTaskTools{Denied: []string{"bash"}}, SkillRefs: []platformv1alpha1.NamedRef{{Name: "web-app-hunting"}, {Name: "trail-of-bits-codeql"}}},
		SecurityScanTask{Name: "secrets-and-credentials", Role: "secrets-auditor", Category: "secrets", Objective: "Hunt for hardcoded secrets, credentials committed to the repository, secrets leaked into logs or errors, and insecure credential storage or transmission.", Tools: &SecurityScanTaskTools{Denied: []string{"bash"}}, SkillRefs: []platformv1alpha1.NamedRef{{Name: "trail-of-bits-zeroize-audit"}}},
		SecurityScanTask{Name: "crypto-and-randomness", Role: "vulnerability-hunter", Category: "crypto", Objective: "Hunt for cryptographic weaknesses: weak or misused algorithms, insecure randomness, missing integrity checks, improper key management, and TLS misconfiguration.", Tools: &SecurityScanTaskTools{Denied: []string{"bash"}}, SkillRefs: []platformv1alpha1.NamedRef{{Name: "trail-of-bits-constant-time-analysis"}, {Name: "trail-of-bits-wycheproof"}}},
		SecurityScanTask{Name: "ssrf-and-network", Role: "vulnerability-hunter", Category: "ssrf", Objective: "Hunt for server-side request forgery and unsafe network egress: user-controlled URLs, open redirects, DNS rebinding exposure, and missing egress restrictions.", Tools: &SecurityScanTaskTools{Denied: []string{"bash"}}, SkillRefs: []platformv1alpha1.NamedRef{{Name: "web-app-hunting"}}},
		SecurityScanTask{Name: "deserialization-and-parsing", Role: "vulnerability-hunter", Category: "deserialization", Objective: "Hunt for unsafe deserialization and parser abuse: untrusted data fed to deserializers, XML external entities, prototype pollution, and resource-exhausting parsers.", Tools: &SecurityScanTaskTools{Denied: []string{"bash"}}, SkillRefs: []platformv1alpha1.NamedRef{{Name: "trail-of-bits-codeql"}, {Name: "trail-of-bits-property-based-testing"}}},
		SecurityScanTask{Name: "access-control-and-multitenancy", Role: "vulnerability-hunter", Category: "authz", Objective: "Hunt for access-control and tenant-isolation flaws: insecure direct object references, missing ownership checks, and cross-tenant data or resource leakage.", Tools: &SecurityScanTaskTools{Denied: []string{"bash"}}, SkillRefs: []platformv1alpha1.NamedRef{{Name: "api-authz-hunting"}}},
		SecurityScanTask{Name: "dependency-and-supply-chain", Role: "dependency-auditor", Category: "supply-chain", Objective: "Hunt for vulnerable or malicious dependencies, unpinned versions, typosquatting risk, and insecure build or release pipeline steps.", Tools: &SecurityScanTaskTools{Denied: []string{"bash"}}, SkillRefs: []platformv1alpha1.NamedRef{{Name: "trail-of-bits-supply-chain-risk-auditor"}, {Name: "github-agent-supply-chain"}}},
		SecurityScanTask{Name: "infrastructure-and-configuration", Role: "vulnerability-hunter", Category: "misconfiguration", Objective: "Hunt for insecure infrastructure and configuration: overly permissive RBAC or IAM, exposed debug endpoints, missing security headers, and unsafe container or deployment settings.", Tools: &SecurityScanTaskTools{Denied: []string{"bash"}}, SkillRefs: []platformv1alpha1.NamedRef{{Name: "cloud-iac-hunting"}}},
		SecurityScanTask{Name: "business-logic", Role: "vulnerability-hunter", Category: "logic-flaw", Objective: "Hunt for business-logic flaws: race conditions, state-machine bypasses, abuse of workflows (payments, quotas, invites), and missing server-side enforcement of invariants.", Tools: &SecurityScanTaskTools{Denied: []string{"bash"}}, SkillRefs: []platformv1alpha1.NamedRef{{Name: "trail-of-bits-sharp-edges"}, {Name: "trail-of-bits-property-based-testing"}}},
	)
	...
	return append(tasks, SecurityScanTask{
		...
		DependsOn: dependsOn,
		Tools:     &SecurityScanTaskTools{Denied: []string{"bash"}},
		SkillRefs: []platformv1alpha1.NamedRef{{Name: "trail-of-bits-fp-check"}, {Name: "bug-bounty-reporting"}},
	})
}
