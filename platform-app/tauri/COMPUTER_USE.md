...
- Native `SCContentSharingPicker` single-window sharing and separate Accessibility onboarding. No broad Screen Recording grant, preflight, request, or fallback.
...
### Native picker migration verification
